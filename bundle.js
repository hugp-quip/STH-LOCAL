async function fetchServerIpAdress () { return fetch("https://localhost:8080/server_ip")}

async function callFetchServerIpAdress() {
  let resp = await fetchServerIpAdress()
  let r = await resp.json()
  console.log("simlucas"+r.ip)
  return await r.ip
}
